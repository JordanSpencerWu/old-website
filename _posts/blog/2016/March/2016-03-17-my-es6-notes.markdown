...
there are always improvements and this is another updated version of JavaScript. The 
...
Looking at the example above you can see that the magic number is `3.14159`. It's hard 
...
Destructuring is a powerful technique that allows you to get only the data you  
need to do a task. You can also you destructuring as a parameter in a function.
...
#### Class
Now with ES6, introduce two ways of defining classes, with a class declaration and 
...
There's many features in Classes that ES6 implemented for dealing with inheritance like 
...
This will DRY our code and the best part is that it will lexically bind the `this` value, this 
